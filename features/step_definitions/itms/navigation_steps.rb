...
# Then(/^User navigate to "([^\"]*)"$/)do |link|
#   navigate_to(link)
# #   sleep 2
# end

# Then(/^User navigate forward/) do
#   navigate('forward')
# end

# Then(/^User navigate back/) do
#   navigate('back')
# end
...
# Then(/^Resize browser window size to width (\d+) and height (\d+)$/) do |width, heigth|
#   resize_browser(width, heigth)
# end

# # step to maximize browser
# Then(/^Maximize browser window$/) do
#   maximize_browser
# end
...
# Then(/^Switch to previous window$/) do
#   switch_to_old_window
# end

# Then(/^Close new window$/) do
#   close_new_window
# end

# # steps to scroll to element
# Then(/^Scroll to element "(.*?)"$/) do |type, element|
#   scroll_to_element(type, element)
# end

# # steps to scroll web page to top or end
# Then(/^Scroll to (top|end) of page$/) do |to|
#   scroll_page(to)
# end
